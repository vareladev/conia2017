...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        ?>
          ...
          <div class="header-section text-center">
            <h2>Contact Us</h2>
            <p>Do you have a question or comment? please contact us.</p>
          ...
          <form action="sndmail.php" method="post" role="form" class="contactForm">
              <div class="col-md-6 col-sm-6 col-xs-12 left">
                <div class="form-group">
                    <input type="text" name="name" class="form-control form" id="name" placeholder="Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 right">
                <div class="form-group">
                    <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Please write something for us"></textarea>
                    <div class="validation"></div>
                </div>
              </div>
    ...
    <div class="header-section text-center">
      <h2>Congress host institution</h2>
      <hr class="bottom-line">
    </div>
		<div>
